...
```{note}
For the full project documentation, visit [faultflow Docs](https://ranaumarnadeem.github.io/faultflow/).
```
...
[Installation](https://github.com/ranaumarnadeem/faultflow/blob/main/docs/getting_started/installation.md).
```
...
[Architecture overview](https://github.com/ranaumarnadeem/faultflow/blob/main/docs/architecture/overview.md)). Changes that violate them will not
hold up:
