// Thin top-level wrapper instantiating genericfir with small, tractable
// parameters (8 taps, 8-bit samples) instead of the vendor default
// (NTAPS=128, IW=12, ~170K-signal synthesis). The vendored genericfir.v
// body is concatenated below this, byte-for-byte unmodified.
`default_nettype none

module genericfir_small (
